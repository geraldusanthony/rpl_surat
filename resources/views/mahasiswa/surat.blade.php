...
<div class="container m-5 p-5">
    ...
    <br>
      <ul class="left ml-5"> 
        <h1>Input Surat Tugas Mahasiswa</h1> 
      </ul>
    <br>
...
<div class="modal-header">
  <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pengajuan Surat Tugas</h5> 
...
<div class="modal-body">
        ...
        <form action="/surat/tambah" method="POST">
          {{csrf_field()}}
          <div class="form-group">
            <label for="exampleInputEmail1">Jenis Surat</label> 
            <input name="jenis_srt"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Surat Tugas">
          </div>
          <div class="form-group">
