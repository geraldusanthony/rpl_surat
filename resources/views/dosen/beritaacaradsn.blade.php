  ...
  @endif
    <div class="row">
        ...
        <table class="table">
          ...
          @foreach ($data_beritaacaradsn as $beritaacaradsn)
              <tr>
              <td>{{$beritaacaradsn->jenis_srt}}</td>
              <td>{{$beritaacaradsn->tgl_pelaksanaan}}</td> 
              <td>{{$beritaacaradsn->lksi_kgt}}</td> 
              <td>{{$beritaacaradsn->nm_mitra}}</td> 
              <td>{{$beritaacaradsn->ket}}</td>
              <td></td> 
              <td><ul class="right">
...
<div class="modal-body">
        ...
        <form action="/surat/tambahsrtba" method="POST">
          {{csrf_field()}}
          <div class="form-group">
            <label for="exampleInputEmail1">Jenis Surat</label> 
            <input name="jenis_srt"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Berita Acara">
          </div>
          <div class="form-group">
